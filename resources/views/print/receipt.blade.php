...
<body>
    <div class="receipt">
        ...
        <div class="receipt-details">
            ...
            <p>
                Received sum of <b>UGX {{ number_format($receipt->amount + $receipt->securty_deposit + $receipt->days_before) }}</b>
                in words: <b>{{ Utils::convert_number_to_words($receipt->amount + $receipt->securty_deposit + $receipt->days_before) }}</b>
