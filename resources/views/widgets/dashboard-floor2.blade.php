...
?><a href="{{ admin_url('rooms') }}"
    class="card {{ $bg }} {{ $border }} mb-4 mb-md-5">
    <div class="card-body py-0 pb-2 pb-md-4">
        <p class="h3  text-bold mb-2 mb-md-3 text-success ">Second Floor</p>
       {{--  <p class="  m-0 text-center text-primary h3" style="line-height: 3.2rem">{{ number_format($rooms->count()) }}</p> --}}
        ...
        <p class="h4  text-bold mb-2 bg-success text-white pl-3 pt-2 pb-1">  FROM B01 -  B20</p>
